...
class gameSuit {
     ...
     logic(){
          if(this.playerChoise == this.comChoise){
               ...
               this.showResult = output_result.innerHTML = "<img src='/assets/Draw.png'>" //Draw
               this.gameResult()
                    ...
                    || (this.playerChoise === 'PAPER' && this.comChoise === 'ROCK')){
                         ...
                         this.showResult = output_result.innerHTML = "<img src='/assets/player-win.png'>" //PLAYER WIN
                         this.gameResult()
          } else {
               this.gameOutput = 'computerWin'
               this.showResult = output_result.innerHTML = "<img src='/assets/computer-win.png'>" //COM WIN
               this.gameResult()
          }
     }
